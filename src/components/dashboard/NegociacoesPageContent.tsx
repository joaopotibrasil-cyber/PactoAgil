      ...
      <section className="section-shell p-8 md:p-10 relative overflow-hidden group">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 relative z-10">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight leading-[1.1] text-white">
      ...
      <section className="section-shell p-8">
        <div className="flex flex-col lg:flex-row gap-4 justify-between mb-8">
          <label className="relative w-full lg:max-w-md group/input">
            ...
            <input
              ...
              className="w-full rounded-[1.25rem] border border-border-soft bg-surface/50 py-3.5 pl-12 pr-4 text-base focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all placeholder:text-foreground/40 text-white"
            />
          </label>
        </div>
        ...
        {loading ? (
              ...
              <tbody className="divide-y divide-border-soft/50">
                {filtered.map((item: any) => (
                  <tr key={item.id} className="hover:bg-surface-dim/30 transition-colors group">
                    <td className="py-4 px-6">
                      <div className="inline-flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <span className="font-semibold text-base text-white">{item.nomeEmpresa}</span>
                    ...
                    <td className="py-4 font-medium text-white">{item.instrumento}</td>
                    <td className="py-4">
          ...
          <div className="py-16 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-white">Nenhuma negociação encontrada</h3>
